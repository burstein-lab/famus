...
- --device - cpu/cuda
- --models - comma-separated list of model names to use. Note that models must be explicitly chosen via the command line argument or config file, otherwise no classification will be performed.
